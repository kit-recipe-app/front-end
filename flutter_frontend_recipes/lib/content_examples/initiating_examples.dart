...
class InitiatingExamples {
  ...
  void createProfiles() {
    Profile profileOfHerbert =
        Profile(name: 'Herbert', vegetarian: true, levelOfCooking: 'Amateur');
    Profile profileOfMargritt =
        Profile(name: 'Margritt', vegetarian: false, levelOfCooking: 'Profi');
    Profile profileOfLucas =
        Profile(name: 'Lucas', vegetarian: false, levelOfCooking: 'Amateur');
    Profile profileOfTim = Profile(
        name: 'Tim', vegetarian: false, levelOfCooking: 'Fortgeschritten');
    Profile profileOfMaria =
        Profile(name: 'Maria', vegetarian: true, levelOfCooking: 'Amateur');
  ...
  void createRecipes() {
    ...
    Recipe recipe1 = Recipe(
        ...
        tags: ['Fleisch', 'Italienisch'],
        description:
            '''Zuerst macht man die Spaghetti in heißes Wasser und fügt etwas Salz hinzu dann 
        ...
        howToMake:
            '''1. Zuerst macht man die Spaghetti in heißes Wasser und fügt etwas Salz hinzu dann 
        ...
        imageUrl:
            'https://www.gutekueche.at/storage/media/recipe/27368/conv/spagetti-bolognese_1482833072-default.jpg');

    List<Ingredients> ingredients2 = [
      Ingredients(
          name: 'Vegetarisches Schnitzel',
          amount: 1,
          unit: unitExamples.stueck),
    ...
    Recipe recipe2 = Recipe(
        title: 'Vegetarisches Schnitzel mit kartoffel',
        time: 40,
        difficulty: 'normal',
        calories: 400,
        vegetarian: true,
        ...
        description:
            '''Zuerst schält man die Kartoffel und dann schneidet man sie
    ...
    Recipe recipe3 = Recipe(
        ...
        description:
            '''Zuerst die Gurke schälen und dann schneiden und dann in eine Schüssel
...
''',
        imageUrl:
            'https://img.chefkoch-cdn.de/rezepte/331471115938348/bilder/1255518/crop-960x720/gurkensalat-mit-essig-und-oel.jpg');
    ...
    Recipe recipe4 = Recipe(
        ...
        tags: ['Vegetarisch', 'Einfach'],
        description:
            'Öl in die Pfanne geben, die Kartoffel in die Pfanne und dann mit Salz umrühren',
        ...
        imageUrl:
            'https://cdn.bbqpit.de/wp-content/uploads/2021/03/11225439/Bratkartoffeln-knusprig-schnell-einfach.jpg');

    List<Ingredients> ingredients5 = [
      Ingredients(
          name: 'Schweinefleisch', amount: 500, unit: unitExamples.gramm),
    ...
    Recipe recipe5 = Recipe(
        ...
        tags: ['Fleisch'],
        description:
            '''Das Fleisch wird nakjdkajsdk adjsakl j saalskj dajdksdjhsakd saj lkj 
        ...
        howToMake:
            '''1. Das Fleisch wird nakjdkajsdk adjsakl j saalskj dajdksdjhsakd saj lkj 
